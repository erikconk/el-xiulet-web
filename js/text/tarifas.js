const space = "&nbsp;"
const infoImg = `<img class='singleCard-icons' src='/el-xiulet-web/assets/info.png'>${space}`
const checkedImg = `<img class='singleCard-icons' src='/el-xiulet-web/assets/check.png'>${space}`
const notImg = `<img class='singleCard-icons' src='/el-xiulet-web/assets/not.png'>${space}`
const moneyImg = `<img class='tarifas-icons' src='/el-xiulet-web/assets/money.png'>${space}`
const newLine = "<br>"
